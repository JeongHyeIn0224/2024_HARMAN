...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart) //interrupt occur, come into this function
{
	...
	{
		HAL_UART_Transmit_IT(&huart2, rxData, sizeof(rxData)); //disable  after sending data
	...
	{
		HAL_UART_Transmit_IT(&huart6, rxData, sizeof(rxData)); //disable  after sending data
	...
	HAL_UART_Receive_IT(&huart2, rxData, sizeof(rxData)); //enable
	  ...
	  uint16_t LED_GPIO_PIN[8] =
	  	  {GPIO_PIN_5, GPIO_PIN_6, GPIO_PIN_7, GPIO_PIN_6,
	  			GPIO_PIN_8, GPIO_PIN_9, GPIO_PIN_8, GPIO_PIN_10};
