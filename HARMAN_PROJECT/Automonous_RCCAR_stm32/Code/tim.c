...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    PB4     ------> TIM3_CH1
    */
    GPIO_InitStruct.Pin = US_R_echo_Pin|US_F_echo_Pin;
    ...
    GPIO_InitStruct.Pin = US_L_echo_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(US_L_echo_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    */
    ...
    HAL_GPIO_Init(motor_right_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA5     ------> TIM2_CH1
    */
    GPIO_InitStruct.Pin = motor_left_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(motor_left_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB4     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(GPIOB, US_R_echo_Pin|US_F_echo_Pin);
